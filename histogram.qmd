...
Powinieneś otrzymać wykres, który wygląda podobnie do przykładu. Domyślnie oś X zawiera wszystkie używane przedziały, co powoduje, że jest dość nieczytelna.
